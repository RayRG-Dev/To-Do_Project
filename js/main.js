...
window.addEventListener('beforeinstallprompt', (event) => {
  ...
  installButton.style.display = 'block'; // Asegúrate de que el botón esté visible

  installButton.addEventListener('click', () => {
    installButton.style.display = 'none'; // Oculta el botón después de hacer clic
    ...
    deferredPrompt.userChoice.then((choiceResult) => {
      ...
      deferredPrompt = null; // Restablece la referencia al prompt diferido
    });
  });
});
